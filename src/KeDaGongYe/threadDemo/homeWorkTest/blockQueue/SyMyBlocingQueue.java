...
public class SyMyBlocingQueue<E> {
    private final List list;
    private final int limit;//有大小限制的

    public SyMyBlocingQueue(int limit) {
        this.limit = limit;
...
//        System.out.println("list : " + list.toString());
    ...
    public static void main(String[] args) {
        final SyMyBlocingQueue<Integer> myBlocingQueue = new SyMyBlocingQueue(10);
    ...
    static class TestRunnable implements Runnable{
        private final SyMyBlocingQueue<Integer> myBlocingQueue;

        TestRunnable(SyMyBlocingQueue<Integer> myBlocingQueue) {
